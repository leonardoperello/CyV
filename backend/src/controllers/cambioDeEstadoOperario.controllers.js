...
export async function tareasAsigandas(id_Operario) {
    ...
    tareas = tareas?.filter(tarea => tarea.estado[tarea.estado.length] === "iniciada");
...
export async function cambioEstadotareaAsiganda(data) {
